...
for i in tqdm(range(train.shape[0])):
    ...
    img = image.load_img('D:/aoi/train_images/train_images/'+train['ID'][i], target_size=(28,28,1), grayscale=True)
...
for i in tqdm(range(test.shape[0])):
    ...
    img = image.load_img('D:/images/train_images/'+test['ID'][i], target_size=(28,28,1), grayscale=True)
...
sample.to_csv('D:/sample.csv', header=True, index=False)